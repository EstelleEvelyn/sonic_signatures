...
var fTopLine = d3.select('svg')
                    ...
                    .attr('x1', '0%')
                    .attr('x2', '50%')
                    .attr('y1', function (d, i) { "use strict"; return buffer + (fSegment * i); })
                    .attr('y2', function (d, i) { "use strict"; return buffer + (fSegment * i); })
                    .style('stroke', 'black');
...
var pTopLine = d3.select('svg')
                    ...
                    .attr('x1', '51%')
                    .attr('x2', '100%')
                    .attr('y1', function (d, i) { "use strict"; return buffer + (pSegment * i); })
                    .attr('y2', function (d, i) { "use strict"; return buffer + (pSegment * i); })
                    .style('stroke', 'black');
...
function compare() {
      ...
      for (i = 0; i < features.length; i = i + 1) {
        ...
        if (feat_data.length !== 0) {
          if (document.getElementById(features[i] + '_prot')) {
            fprot_pos = document.getElementById(features[i] + '_prot').getAttribute('x');
            fprot_pos = parseFloat(fprot_pos);
          }
          if (document.getElementById(features[i] + '_ant')) {
            fant_pos = document.getElementById(features[i] + '_ant').getAttribute('x');
            fant_pos = parseFloat(fant_pos);
          }
          if (document.getElementById(features[i] + '_fool')) {
            ffool_pos = document.getElementById(features[i] + '_fool').getAttribute('x');
          ...
          if (document.getElementById(features[i] + '_prot')) {
            fprot_rect = d3.select('#' + features[i])
              .append('rect')
              ...
              .attr('y', function () {
                return document.getElementById(features[i] + '_prot').getAttribute('y');
              })
              .attr('width',  function () {
                ...
                return fprot_width.toString() + '%';
              })
              .attr('height', function () {
                return document.getElementById(features[i] + '_prot').getAttribute('height');
              })
              .style('stroke', 'black')
              .style('opacity', '0.5')
              .style('fill', function () {
          ...
          if (document.getElementById(features[i] + '_ant')) {
            fant_rect = d3.select('#' + features[i])
              .append('rect')
              .property('id', document.getElementById('fCharacter').value)
              .attr('class', 'fant_bar')
              .attr('x', function () {
              ...
              .attr('y', function () {
                return document.getElementById(features[i] + '_ant').getAttribute('y');
              })
              .attr('width',  function () {
          ...
          if (document.getElementById(features[i] + '_fool')) {
            ffool_rect = d3.select('#' + features[i])
              .append('rect')
              .property('id', document.getElementById('fCharacter').value)
  ...
  if (document.getElementById('pCharacter').value !== 'default') {
    ...
    dataURL = '/compare/'+document.getElementById('pCharacter').value
    d3.json(dataURL, function(error, data){
...
function loadData() {
  ...
  d3.json(dataURL, function (error, data) {
    ...
    for (i = 0; i < features.length; i = i + 1) {
      feat_bars = d3.select('#' + features[i])
        .selectAll('rect')
        .data(fdata[features[i]])
        .enter()
        .append('rect')
    ...
    if (hide.length === 3) {
      ...
      if (show[0].value === 'protag') {
        ...
        d3.selectAll('.fant')//.attr('transform', 'translate(0,' + ( - fSegment/3) + ')')
          ...
          .attr('y', function () {
            return (d3.select(this).attr('y') - fSegment / 3);
          });
      } else {
        d3.selectAll('.fprot').remove();
        d3.selectAll('.fant').remove();
        d3.selectAll('.ffool')//.attr('transform', 'translate(0,' + ( - 2 * fSegment/3) + ')')
          .attr('height', fSegment - buffer / 2)
          .attr('y', function () {
            return (d3.select(this).attr('y') - 2 * fSegment / 3);
          });
      }
      ...
      if (hide[0].value === 'protag') {
        ...
        d3.selectAll('.ffool')//.attr('transform', 'translate(0,'+(- fSegment/6)+')')
          .attr('height', fSegment / 2 - buffer / 2)
          .attr('y', function () {
            return (d3.select(this).attr('y') - fSegment / 6);
          });
        ...
        d3.selectAll('.fant')
          .attr('height', fSegment / 2 - buffer / 2)
          .attr('y', function () {
            return (parseFloat(d3.select(this).attr('y')) + fSegment / 6);
          });
        d3.selectAll('.fprot').attr('height', fSegment / 2 - buffer / 2);
      }
    }

    for (i = 0; i < features.length; i = 1 + 1) {
      if (d3.select('#' + features[i] + '_prot')[0][0] !== null) {
        fprot_labels = d3.select('#' + features[i])
          .append('text')
//                        .attr('x', function() {
...
//                        })
      ...
      if (d3.select('#' + features[i] + '_ant')[0][0] !== null) {
        fant_labels = d3.select('#' + features[i])
          .append('text')
          .attr('x', '25.5%')
//                        .attr('x', function() {
...
//                        })
      ...
      if (d3.select('#' + features[i] + '_fool')[0][0] !== null) {
        ffool_labels = d3.select('#' + features[i])
          .append('text')
          .attr('x', '25.5%')
//                        .attr('x', function() {
...
//                        })
    ...
    for (i = 0; i < phonemes.length; i = i + 1) {
      phon_bars =   d3.select('#' + phonemes[i])
        .selectAll('rect')
        .data(pdata[phonemes[i]])
        .enter()
        .append('rect')
        .property('id', function (d, j) {
          if (j === 0) {
    ...
    if (hide.length === 3) {
      ...
      if (show[0].value === 'protag') {
        ...
        d3.selectAll('.pant')
          ...
          .attr('y', function () {
            return (parseFloat(d3.select(this).attr('y')) - pSegment / 3);
          });
      } else {
        d3.selectAll('.pprot').remove();
        d3.selectAll('.pant').remove();
        d3.selectAll('.pfool')
          .attr('height', pSegment - buffer / 2)
          .attr('y', function () {
            return (parseFloat(d3.select(this).attr('y')) - 2 * pSegment / 3);
          });
      }
    } else if (hide.length === 1) {
      if (hide[0].value === 'protag') {
        ...
        d3.selectAll('.pfool')
          .attr('height', pSegment / 2 - buffer / 2)
          .attr('y', function () {
            return (parseFloat(d3.select(this).attr('y')) - pSegment / 6);
          });
      } else if (hide[0].value === 'antag') {
        d3.selectAll('.pant').remove();
    ...
    for (i = 0; i < phonemes.length; i = i + 1) {
      if (d3.select('#' + phonemes[i] + '_prot')[0][0] !== null) {
        pprot_labels = d3.select('#' + phonemes[i])
          .append('text')
          .attr('x', '76%')
//                        .attr('x', function() {
...
//                        })
      ...
      if (d3.select('#'  + phonemes[i]  + '_ant')[0][0] !== null) {
        pant_labels = d3.select('#' + phonemes[i])
          .append('text')
          .attr('x', '76%')
//                        .attr('x', function() {
...
//                        })
      ...
      if (d3.select('#' + phonemes[i] + '_fool')[0][0] !== null) {
        pfool_labels = d3.select('#' + phonemes[i])
          .append('text')
          .attr('x', '76%')
  //                        .attr('x', function() {
