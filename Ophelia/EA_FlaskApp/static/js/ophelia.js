...
d3.csv(DATA_URL,
    ...
    function(error, data) {
        ...
        var playCharNest = calculateNest(data);
        ...
        function findChecked() {
            ...
            var checkedBoxes = d3.selectAll(".characterCheckBoxes:checked")._groups[0];
        ...
        function doEricsThing(){
            ...
            tvUrl += currentPlay + '_' + d3.select(this).data()[0].key + '_orig3.csv';
            window.open(tvUrl);
        }
        ...
        function zoom(d) {
            ...
            var details = d3.selectAll(".emptyDetail").selectAll("svg")
                .data([d])
                .enter()
                .append("svg:svg")
                .attr("width", "100%")
        ...
        function drawDetails(d){
            ...
            var LeftAxis = d3.axisLeft(d3.scaleLinear().domain(domains.detaildomain).range([0,200]));
